...
const MODELOS_IMPRESORA = {
  ZEBRA: [
    ...
    { value: 'ZT410_200', label: 'Zebra ZT410 (200 DPI)', dpi: 200, descripcion: 'Industrial, cabezal 200 DPI' },
...
export function ConfigRotulosModule({ operador, modoEditor: modoEditorProp, onVolverDeEditor }: Props) {
  ...
  const datosPrueba: Record<string, string> = {
    ...
    'TIPO_ANIMAL': '2D - NT',
    'DENTICION': '2',
    'FECHA_ACTUAL': '21/05/2026',
    'MATRICULA_TIPIFICADOR': 'TIP-001',
    'MATRICULA_USUARIO_FAENA': 'MAT-987654',
    'CUIT_USUARIO': '30-87654321-0',
    'RAZA': 'ANGUS',
  ...
  const descripcionVariable: Record<string, string> = {
    ...
    'KG': 'Peso (kg)',
    'LADO': 'Lado (IZQ/DER)',
    'TIPO_ANIMAL': 'Tipo de animal con dentición (ej: 2D - NT)',
    'DENTICION': 'Cantidad de dientes',
    'FECHA_ACTUAL': 'Fecha actual',
    'MATRICULA_TIPIFICADOR': 'Matrícula del tipificador',
    'MATRICULA_USUARIO_FAENA': 'Matrícula usuario faena',
    'CUIT_USUARIO': 'CUIT del usuario de faena',
...
✅ IMPRESIÓN DIRECTA: Configure la IP de la impresora y 
  ...
  const detectarVariables = (contenido: string, tipoImpresora: string): VariableDetectada[] => {
    ...
    const mapeoCampos: Record<string, { campo: string; descripcion: string }> = {
      ...
      'PESO_KG': { campo: 'peso', descripcion: 'Peso (kg)' },
      'KG': { campo: 'peso', descripcion: 'Peso (kg)' },
      'LADO': { campo: 'ladoMedia', descripcion: 'Lado (IZQ/DER)' },
      'TIPO_ANIMAL': { campo: 'tipoAnimal', descripcion: 'Tipo con dentición (ej: 2D - NT)' },
      'DENTICION': { campo: 'denticion', descripcion: 'Cantidad de dientes' },
      'FECHA_ACTUAL': { campo: 'fechaActual', descripcion: 'Fecha actual' },
      'MATRICULA_TIPIFICADOR': { campo: 'matriculaTipificador', descripcion: 'Matrícula tipificador' },
      'MATRICULA_USUARIO_FAENA': { campo: 'matriculaUsuarioFaena', descripcion: 'Matrícula usuario faena' },
      'CUIT_USUARIO': { campo: 'cuitUsuario', descripcion: 'CUIT del usuario de faena' },
