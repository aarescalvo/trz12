...
export function PagosSaldosTab({ operador }: Props) {
  ...
  const EstadoBadge = ({ estado }: { estado: string }) => {
    switch (estado) {
      ...
      case 'VENCIDO':
        return (
          <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-[10px] font-semibold bg-red-500/20 text-red-400 border border-red-500/30 animate-pulse">
    ...
    <div className="space-y-4">
      ...
      {kpis && (
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-3">
          ...
          {/* Facturas Vencidas */}
          <Card className="bg-slate-800/50 border-red-500/30 shadow-lg">
            <CardContent className="p-4">
              <div className="flex items-center gap-3">
            ...
            <CardContent className="p-4">
              <div className="flex items-center gap-3">
                ...
                <div className="min-w-0">
                  ...
                  <p className="text-sm font-bold text-orange-300 truncate">
          ...
          <div className="flex flex-wrap items-center gap-2">
            ...
            <div className="relative flex-1 min-w-[200px]">
              ...
              <Input
                ...
                className="pl-9 h-9 bg-slate-900/50 border-slate-600/50 text-slate-200 placeholder:text-slate-500 focus:border-slate-500"
              />
            </div>
            ...
            <Button
              ...
              className={
                soloVencidas
                  ...
                  : 'h-9 border-slate-600/50 text-slate-300 hover:bg-slate-700/50 hover:text-slate-200'
              }
            ...
            <Button
              variant="outline"
              size="sm"
              className="h-9 border-slate-600/50 text-slate-300 hover:bg-slate-700/50 hover:text-slate-200"
              onClick={fetchData}
              disabled={loading}
            >
              <RefreshCw
      ...
      <Card className="bg-slate-800/50 border-slate-700/50 shadow-lg">
          ...
          <table className="w-full text-xs">
            <thead className="sticky top-0 z-10">
              <tr className="bg-slate-900/80 border-b border-slate-700/50">
                <th className="text-left px-3 py-2.5 font-semibold text-slate-400 whitespace-nowrap">
                  N° Factura
                </th>
                <th className="text-left px-3 py-2.5 font-semibold text-slate-400 whitespace-nowrap">
                  Cliente
                ...
                <th className="text-right px-3 py-2.5 font-semibold text-slate-400 whitespace-nowrap">
                  Total Factura
                </th>
                <th className="text-right px-3 py-2.5 font-semibold text-slate-400 whitespace-nowrap">
                  Total Pagado
                ...
                <th className="text-center px-3 py-2.5 font-semibold text-slate-400 whitespace-nowrap">
                  Plazo (días)
                </th>
                <th className="text-center px-3 py-2.5 font-semibold text-slate-400 whitespace-nowrap">
                  Días Transc.
          ...
          <div className="flex items-center justify-between px-4 py-3 border-t border-slate-700/50">
            ...
            <div className="flex items-center gap-1">
              <Button
                variant="outline"
                size="sm"
                className="h-7 px-2 text-slate-400 border-slate-600/50 hover:bg-slate-700/50"
        ...
        {!loading && filtered.length > 0 && (
          <div className="px-4 py-3 border-t border-slate-700/50 bg-slate-900/30 text-xs">
      ...
      <Dialog open={pagoOpen} onOpenChange={setPagoOpen}>
        <DialogContent className="max-w-md bg-slate-800 border-slate-700 text-slate-200">
          <DialogHeader>
          ...
          {facturaSeleccionada && (
            <div className="space-y-4">
              {/* Factura summary */}
              <div className="bg-slate-900/50 rounded-lg p-3 space-y-1.5 border border-slate-700/50">
              ...
              <div className="space-y-1.5">
                ...
                <Input
                  ...
                  className="h-10 bg-slate-900/50 border-slate-600/50 text-slate-200 font-mono text-lg font-bold focus:border-emerald-500"
                />
                {facturaSeleccionada &&
              ...
              <div className="space-y-1.5">
                ...
                >
                  <SelectTrigger className="h-10 bg-slate-900/50 border-slate-600/50 text-slate-200">
                    <SelectValue />
                  </SelectTrigger>
              ...
              <div className="space-y-1.5">
                ...
                <Input
                  ...
                  className="h-10 bg-slate-900/50 border-slate-600/50 text-slate-200"
                />
              </div>
              ...
              <div className="grid grid-cols-2 gap-3">
                <div className="space-y-1.5">
                  ...
                  <Input
                    ...
                    className="h-9 bg-slate-900/50 border-slate-600/50 text-slate-200 placeholder:text-slate-500"
                  />
                </div>
                <div className="space-y-1.5">
                  <Label className="text-xs font-semibold text-slate-300">
              ...
              <div className="space-y-1.5">
                ...
                <Textarea
                  ...
                  rows={2}
                  className="bg-slate-900/50 border-slate-600/50 text-slate-200 placeholder:text-slate-500 resize-none"
                />
              </div>
            </div>
          )}
