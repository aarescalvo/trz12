...
const VARIABLES_PESAJE_90x60 = JSON.stringify([
...
export async function POST(request: NextRequest) {
  ...
  try {
    const rotulos = [
      // ZEBRA ZT410 (200 DPI) - Pesaje Individual 90x60mm
      {
        nombre: 'Pesaje Individual 90x60mm - Zebra ZT410 (200 DPI)',
        codigo: 'PESAJE_IND_90x60_200DPI',
        tipo: TipoRotulo.MEDIA_RES,
        categoria: 'PESAJE_INDIVIDUAL',
        tipoImpresora: 'ZEBRA',
        modeloImpresora: 'ZT410_200',
        ancho: 90,
        alto: 60,
        dpi: 200,
        contenido: ZPL_PESAJE_INDIVIDUAL_90x60,
        variables: VARIABLES_PESAJE_90x60,
        diasConsumo: 30,
        temperaturaMax: 5.0,
        activo: true,
        esDefault: true
